                            ...
                            <div class="col-12">
                                <div class="mix-nav text-center offer-mix-nav">
                                    ...
                                    @foreach($houses as $index => $hi)
                                        @if($index === 0)
                                            <a href="/uploads/gallery/images/{{$hi->file}}" class="btn btn-theme mt-0 swipebox" rel="gallery-{{$hi->gallery_id}}" title="Domki nad morzem"><span><i class="las la-image"></i></span>Galeria</a>
                                            @break
                                        @endif
                                    @endforeach
