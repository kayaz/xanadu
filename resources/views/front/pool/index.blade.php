        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-left">
                    ...
                    <p><b>Za dodatkową opłatą</b> (usługa płatna wg. cennika na rok 2021) do dyspozycji naszych gości, <b>na terenie zaprzyjaźnionego ośrodka wczasowego oddalonego od Xanadu o zaledwie 100 metrów</b>, dostępny jest basen zewnętrzny z podgrzewaną wodą i atrakcjami dla dzieci i dorosłych. Znajdują się tu między innymi:</p>
                    <p>&nbsp;</p>
                    <ul class="mb-0">
            ...
            <div class="row mt-5 pt-3">
                <div class="col-12 d-flex justify-content-center">
                    <div class="icon-box icon-box-blue">
                        <div>
                            <img src="https://xanaduhotel.test/images/icons/icon-houses.png" alt="" width="70" height="70">
                            <h3>Basen rekreacyjny</h3>
                        </div>
                    </div>
                    <div class="icon-box icon-box-blue">
                        <div>
                            <img src="https://xanaduhotel.test/images/icons/icon-rooms.png" alt="" width="70" height="70">
                            <h3>Brodzik dla dzieci</h3>
                        </div>
                    </div>
                    <div class="icon-box icon-box-blue">
                        <div>
                            <img src="https://xanaduhotel.test/images/icons/icon-food.png" alt="" width="70" height="70">
                            <h3>Jacuzzi</h3>
                        </div>
                    </div>
                    <div class="icon-box icon-box-blue">
                        <div>
                            <img src="https://xanaduhotel.test/images/icons/icon-parking.png" alt="" width="70" height="70">
                            <h3>Sauna fińska</h3>
                        </div>
                    </div>
                </div>
